...
export default function OzonInfoDebugModal({ articleId, onClose }: Props) {
  ...
  return (
    <>
      ...
      <aside
        className="drawer"
        role="dialog"
        aria-label="Ozon /v3/product/info/list"
        style={{ width: "min(900px, 95vw)" }}
      >
        <div className="drawer-header">
          <h3>
            Ozon /v3/product/info/list · <code>{articleId}</code>
          </h3>
          <button
            className="btn-icon"
            onClick={onClose}
            ...
            <>
              <section className="card">
                ...
                <p className="muted" style={{ fontSize: 12, marginBottom: 8 }}>
                  Ищи поля <code>archived</code>, <code>visibility_details</code>{" "}
                  (<code>active_product</code>, <code>has_price</code>,{" "}
                  <code>has_stock</code>) и <code>status</code> для диагностики
                  бейджа неактивности.
                </p>
                <pre
                  style={{
